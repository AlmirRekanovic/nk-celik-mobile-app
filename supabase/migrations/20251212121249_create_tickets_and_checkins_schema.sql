/*
  ...
  1. New Tables
    - `tickets`
      ...
      - `ticket_code` (text, unique) - QR code value
      - `ticket_type` (text) - Type of ticket
      - `customer_email` (text) - Email from WooCommerce order
      - `customer_name` (text)
      - `member_id` (uuid, foreign key, optional) - Link to member if they're registered
      - `event_name` (text)
    ...
    - `ticket_checkins`
      ...
      - `checked_in_by` (uuid, foreign key) - References members table
      - `location` (text) - Optional check-in location
  ...
  2. Security
    ...
    - Members can view tickets linked to their member account
    - Only admin users can perform check-ins
*/
